...
clear
echo -e " $COLOR1┌─────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   \e[33m     • TROJAN-GO MENU •       ${NC}"
echo -e " $COLOR1└─────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌─────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 │$NC   \e[33m[1]  • CREATE TROJAN-GO ACCOUNT ${NC}"
echo -e "$COLOR1 │$NC   \e[33m[2]  • TRIAL TROJAN-GO ACCOUNT         ${NC}"
echo -e "$COLOR1 │$NC   \e[33m[3]  • RENEW TROJAN-GO ACCOUNT         ${NC}"
echo -e "$COLOR1 │$NC   \e[33m[4]  • DELETE TROJAN-GO ACCOUNT         ${NC}"
echo -e "$COLOR1 │$NC   \e[33m[5]  • CHECK USER LOGIN ACCOUNT   ${NC}"
echo -e "$COLOR1 │$NC   \e[33m[6]  • DETAIL TROJAN-GO ACOUNT         ${NC}"
