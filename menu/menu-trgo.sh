...
echo -e ""
echo -e "${yelow} ┌───────────────────────────────────────┐${NC}"
echo -e "${yelow} │${cyann}      MENU MANAGER TROJAN-GO    ${NC}"
echo -e "${yelow} └───────────────────────────────────────┘${NC}"
echo -e "${yelow} ┌───────────────────────────────────────┐${NC}"
echo -e "${yelow} │  ${cyann}[•1] Creating TROJAN-GO Account${NC}"
echo -e "${yelow} │  ${cyann}[•2] Trial TROJAN-GO Account${NC}"
echo -e "${yelow} │  ${cyann}[•3] Renew TROJAN-GO Account${NC}"
echo -e "${yelow} │  ${cyann}[•4] Delete TROJAN-GO Account${NC}"
echo -e "${yelow} │  ${cyann}[•5] Check TROJAN-GO login Account${NC}"
echo -e "${yelow} │  ${red}[•0] Exit TROJAN-GO manager${NC}"
echo -e "${yelow} └───────────────────────────────────────┘${NC}"
echo -e ""
